...
export default function Home() {
  return (
    <div className="flex min-h-screen max-h-screen font-[family-name:var(--font-geist-sans)] bg-primary-700">
      ...
      <main className="md:my-6 md:mr-6 flex flex-col w-full bg-primary-300 md:rounded-3xl justify-center items-center">
        {/* <section className="flex flex-col bg-white rounded-2xl shadow-md p-8">
          <MultiStepForm />
        </section> */}
