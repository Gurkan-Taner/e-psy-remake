...
const items = [
  { label: "Anxiété / Stress", name: "stresse" },
  { label: "Dépression", name: "depression" },
  { label: "Estime de soi", name: "estime" },
  { label: "Addictions", name: "addiction" },
  { label: "Solitude", name: "solitude" },
  { label: "Autres", name: "autres" },
];
        ...
        >
          {items.map((item, i) => (
            <div
              ...
              onClick={() => setTherapieSubject(item.name)}
            >
              <RadioGroupItem
                value={item.name}
                id={item.name}
